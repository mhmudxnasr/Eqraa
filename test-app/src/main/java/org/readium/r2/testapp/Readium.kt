...
@OptIn(ExperimentalReadiumApi::class)
val FontFamily.Companion.AMIRI: FontFamily get() = FontFamily("Amiri")

@OptIn(ExperimentalReadiumApi::class)
val FontFamily.Companion.VAZIRMATN: FontFamily get() = FontFamily("Vazirmatn")

@OptIn(ExperimentalReadiumApi::class)
val FontFamily.Companion.LORA: FontFamily get() = FontFamily("Lora")

@OptIn(ExperimentalReadiumApi::class)
val FontFamily.Companion.ATKINSON: FontFamily get() = FontFamily("Atkinson")
