...
import org.readium.r2.testapp.reader.preferences.ReaderSettingsBottomSheet
...
abstract class VisualReaderFragment : BaseReaderFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.overlay.setContent {
            ...
            val prefs = remember { org.readium.r2.testapp.settings.ReadingPreferences(context, model.bookId.toString()) }
