...
import com.eqraa.reader.reader.preferences.MainPreferencesBottomSheetDialogFragment
        ...
        menuHost.addMenuProvider(
            object : MenuProvider {
                override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
                    ...
                    // Settings is now handled by VisualReaderFragment's unified sheet
                    // menu.findItem(R.id.settings).isVisible = navigator is Configurable<*, *>
