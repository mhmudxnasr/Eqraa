...
import com.eqraa.reader.databinding.ActivityReaderBinding
...
open class ReaderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ensure content draws behind status bar
    ...
    override fun onPause() {
        ...
        com.eqraa.reader.data.SyncWorker.enqueue(applicationContext)
    }
    ...
    private fun showConflictDialog(local: com.eqraa.reader.data.model.ReadingPosition?, remote: com.eqraa.reader.data.model.ReadingPosition) {
        ...
        dialog.setListener(object : ConflictResolutionDialogFragment.ConflictResolutionListener {
            ...
            override fun onJumpToSynced(targetPosition: com.eqraa.reader.data.model.ReadingPosition) {
                // 1. Update DB
