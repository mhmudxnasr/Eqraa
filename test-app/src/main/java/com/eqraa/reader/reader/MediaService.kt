...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.eqraa.reader.Application
            get() = application as com.eqraa.reader.Application
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.eqraa.reader.Application).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.eqraa.reader.reader.MediaService"
