    ...
    suspend fun saveProgress(
        ...
        try {
            ...
            if (userId != null) {
                ...
                val compressedCfi = com.eqraa.reader.utils.CFICompressor.compress(cfi)
        ...
        try {
            ...
            if (dto != null) {
                return@withContext ReadingPosition(
                    bookId = bookIdentifier,
                    cfi = com.eqraa.reader.utils.CFICompressor.decompress(dto.cfi),
